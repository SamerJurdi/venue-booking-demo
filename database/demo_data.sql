...
VALUES
('2025-04-16 09:00:00', '2025-04-16 10:00:00', FALSE, 'Student Committee Meeting', 'A collaborative session where student committee members come together to discuss upcoming events, share updates, and plan initiatives to enhance the campus experience.', 'meetingReservation', 4, 1, NULL),
('2025-04-16 09:00:00', '2025-04-16 10:00:00', TRUE, 'Student Committee Meeting 1/3', 'A collaborative session where student committee members come together to discuss upcoming events, share updates, and plan initiatives to enhance the campus experience.', 'meetingReservation', 4, 1, 1),
('2025-04-16 11:00:00', '2025-04-16 12:30:00', TRUE, 'Graduation Ceremony', 'A proud and joyful celebration honoring our graduating students and their incredible journey. Join us as we recognize their hard work, cherished memories, and the exciting adventures that lie ahead.', 'eventReservation', 2, 1, NULL),
('2025-04-17 09:00:00', '2025-04-17 10:00:00', TRUE, 'Student Committee Meeting 2/3', 'A collaborative session where student committee members come together to discuss upcoming events, share updates, and plan initiatives to enhance the campus experience.', 'meetingReservation', 4, 1, 1),
('2025-04-17 10:00:00', '2025-04-17 11:00:00', TRUE, 'Music Club Festival', 'An exciting celebration hosted by the Music Club, featuring live performances, student bands, and a vibrant showcase of musical talent from across campus.', 'eventReservation', 4, 1, NULL),
('2025-04-17 13:00:00', '2025-04-17 14:00:00', TRUE, 'Cybersecurity Workshop', 'An interactive workshop focused on essential cybersecurity practices, threat awareness, and hands-on techniques to help participants protect their digital presence.', 'conferenceReservation', 2, 1, NULL),
('2025-04-18 09:00:00', '2025-04-18 10:00:00', TRUE, 'Student Committee Meeting 3/3', 'A collaborative session where student committee members come together to discuss upcoming events, share updates, and plan initiatives to enhance the campus experience.', 'meetingReservation', 4, 1, 1),
('2025-04-18 15:00:00', '2025-04-18 16:00:00', TRUE, 'Local Tech Leaders CON25', 'A gathering of the brightest minds in the local tech scene, CON25 brings together innovators, entrepreneurs, and developers to share ideas, showcase projects, and spark collaboration.', 'conferenceReservation', 4, 1, NULL);
